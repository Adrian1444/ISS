...
set CLASSPATH=%APP_HOME%\lib\Biblioteca-1.0-SNAPSHOT.jar
set MODULE_PATH=%APP_HOME%\lib\javafx-fxml-16-win.jar;%APP_HOME%\lib\javafx-controls-16-win.jar;%APP_HOME%\lib\javafx-controls-16.jar;%APP_HOME%\lib\javafx-graphics-16-win.jar;%APP_HOME%\lib\javafx-graphics-16.jar;%APP_HOME%\lib\javafx-base-16-win.jar;%APP_HOME%\lib\javafx-base-16.jar;%APP_HOME%\lib\formsfx-core-11.3.2.jar

@rem Execute Biblioteca
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %BIBLIOTECA_OPTS%  -classpath "%CLASSPATH%" --module-path "%MODULE_PATH%" --module com.bibllioteca.biblioteca/com.bibllioteca.biblioteca.HelloApplication %*
...
if  not "" == "%BIBLIOTECA_EXIT_CONSOLE%" exit 1
exit /b 1
